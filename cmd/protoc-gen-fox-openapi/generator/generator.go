...
import (
	...
	wk "github.com/go-fox/fox/cmd/protoc-gen-fox-openapi/generator/wellknown"
)

// Configuration holds configuration options for the generator.
			...
			if property.Value.GetReference().GetXRef() == "#/components/schemas/FoxFile" {
				property.Value = &v3.SchemaOrReference{
					Oneof: &v3.SchemaOrReference_Schema{
						Schema: &v3.Schema{
							Type:        "string",
							Description: property.Value.GetReference().Description,
							Format:      "binary",
						},
					},
				}
