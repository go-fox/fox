...
type PagingRequest struct {
	...
	Query         *string                `protobuf:"bytes,3,opt,name=query,proto3,oneof" json:"query,omitempty"`                        // 查询条件，解析为https://github.com/go-fox/go-utils/blob/main/pagination/condition.go
