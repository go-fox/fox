...
type PagingRequest struct {
	...
	Query         string                 `protobuf:"bytes,3,opt,name=query,proto3" json:"query,omitempty"`                        // 查询条件，解析为https://github.com/go-fox/go-utils/blob/main/pagination/condition.go的Where结构体
	OrderBy       string                 `protobuf:"bytes,4,opt,name=order_by,json=orderBy,proto3" json:"order_by,omitempty"`     // 排序字段
	NoPaging      bool                   `protobuf:"varint,5,opt,name=no_paging,json=noPaging,proto3" json:"no_paging,omitempty"` // 是否不分页，如果为true则page和size无效
	Fields        string                 `protobuf:"bytes,6,opt,name=fields,proto3" json:"fields,omitempty"`                      // 要查询的字段，如果为空则查询全部字段
...
var file_pagination_pagination_proto_rawDesc = string([]byte{
	...
	0x69, 0x6e, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x12, 0x08, 0x70,
	0x72, 0x6f, 0x74, 0x6f, 0x63, 0x6f, 0x6c, 0x22, 0x9d, 0x01, 0x0a, 0x0d, 0x50, 0x61, 0x67, 0x69,
	...
	0x52, 0x05, 0x71, 0x75, 0x65, 0x72, 0x79, 0x12, 0x19, 0x0a, 0x08, 0x6f, 0x72, 0x64, 0x65, 0x72,
	0x5f, 0x62, 0x79, 0x18, 0x04, 0x20, 0x01, 0x28, 0x09, 0x52, 0x07, 0x6f, 0x72, 0x64, 0x65, 0x72,
	0x42, 0x79, 0x12, 0x1b, 0x0a, 0x09, 0x6e, 0x6f, 0x5f, 0x70, 0x61, 0x67, 0x69, 0x6e, 0x67, 0x18,
	...
	0x06, 0x66, 0x69, 0x65, 0x6c, 0x64, 0x73, 0x42, 0x97, 0x01, 0x0a, 0x0c, 0x63, 0x6f, 0x6d, 0x2e,
	0x70, 0x72, 0x6f, 0x74, 0x6f, 0x63, 0x6f, 0x6c, 0x42, 0x0f, 0x50, 0x61, 0x67, 0x69, 0x6e, 0x61,
	...
	0x69, 0x6f, 0x6e, 0xa2, 0x02, 0x03, 0x50, 0x58, 0x58, 0xaa, 0x02, 0x08, 0x50, 0x72, 0x6f, 0x74,
